...
[![x-cmd/install — grype Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/grype.svg?lang=zh)](https://x-cmd.com/install/grype)
...
合计: **199,512** 行代码（覆盖前 5 种语言、共 **1374** 个文件）。
...
- **Star**: 12,921 · **Fork**: 886 · **开放 issue**: 1,233 · **贡献者**: 154

## 累计统计

- **发布数**: 203 · **已合并 PR**: 2102 · **开放 PR**: 84 · **已关闭 issue**: 907 · **开放 issue**: 326 · **提交数**: 2370

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 2 | 26 | 17 | 4 | 4 | 26 |
| last60d | 2026-07-26 | 4 | 49 | 33 | 10 | 10 | 50 |
| 90d | 2026-06-26 | 6 | 88 | 41 | 21 | 14 | 92 |
| last180d | 2026-03-28 | 11 | 197 | 59 | 46 | 41 | 202 |
| 360d | 2025-09-29 | 28 | 412 | 70 | 95 | 81 | 415 |
| last720d | 2024-10-04 | 59 | 944 | 78 | 230 | 153 | 948 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/grype.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:23:33Z._
