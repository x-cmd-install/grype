...
[![x-cmd/install — grype Code Quality Monitoring Repo Card](https://repo.x-cmd.io/grype.svg?lang=zh)](https://x-cmd.com/install/grype)
...
- **Star**: 12,906 · **Fork**: 883 · **开放 issue**: 1,230 · **贡献者**: 154

## 累计统计

- **发布数**: 203 · **已合并 PR**: 2102 · **开放 PR**: 77 · **已关闭 issue**: 906 · **开放 issue**: 324 · **提交数**: 2370
...
_数据快照: `data/card/260920.yml` · 2026-09-20T05:39:31Z._
